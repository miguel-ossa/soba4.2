...
public class DisputeTxController extends AbstractController {
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request,
        ...
        aclTxManager.disputeTransaction(txId);
        return new ModelAndView("redirect:transactionList.htm?accountId=" + accountId);
    }
}
