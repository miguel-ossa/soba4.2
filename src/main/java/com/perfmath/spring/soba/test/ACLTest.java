...
/**
 * Tests SPRING 3 ACL with Transaction.
 *
 */
public class ACLTest implements InitializingBean {
    //~ Instance fields ================================================================================================
...
/*
        try {
            ...
            template.execute("TRUNCATE TABLE CONTACTS");
            template.execute("DELETE FROM AUTHORITIES WHERE AUTHORITY = 'ROLE_USER' OR  AUTHORITY = 'ROLE_SUPERVISOR'");
            template.execute("DELETE FROM USERS WHERE CREATE_DATE IS NULL");
            template.execute("TRUNCATE TABLE ACL_ENTRY");
            template.execute("TRUNCATE TABLE ACL_OBJECT_IDENTITY");
            template.execute("TRUNCATE TABLE ACL_CLASS");
            template.execute("TRUNCATE TABLE ACL_SID");
...
/*
        ...
        //INSERT INTO TRANSACTION (TRANSACTION_ID, TRANS_DATE, TYPE, INITIATOR, DESCRIPTION, AMOUNT, BALANCE, ACCOUNT_ID) VALUES (
        //		TRANSACTION_ID_SEQ.NEXTVAL, ts, 'test', 'test', 'test', 10.0, 0, '658376327');      
        for (int i = 0; i < createEntities; i++) {
        	Timestamp ts = new Timestamp(System.currentTimeMillis());
        template.execute("INSERT INTO TRANSACTION (TRANSACTION_ID, TRANS_DATE, TYPE, INITIATOR, DESCRIPTION, AMOUNT, " +
        		"BALANCE, ACCOUNT_ID) VALUES ('" + i + "', {ts '" + ts + "'}, 'test', 'test', 'test', 10.0, 0, '658376327')");

        }
      

        template.execute("INSERT INTO USERS (USERNAME, PASSWORD, ENABLED) VALUES('rod','a564de63c2d0da68cf47586ee05984d7',1)");
        template.execute("INSERT INTO USERS  (USERNAME, PASSWORD, ENABLED) VALUES('dianne','65d15fe9156f9c4bbffd98085992a44e',1)");
        template.execute("INSERT INTO USERS  (USERNAME, PASSWORD, ENABLED) VALUES('scott','2b58af6dddbd072ed27ffc86725d7d3a',1)");
        template.execute("INSERT INTO USERS  (USERNAME, PASSWORD, ENABLED) VALUES('peter','22b5c9accc6e1ba628cedc63a72d57f8',0)");
        template.execute("INSERT INTO USERS  (USERNAME, PASSWORD, ENABLED) VALUES('bill','2b58af6dddbd072ed27ffc86725d7d3a',1)");
        template.execute("INSERT INTO USERS  (USERNAME, PASSWORD, ENABLED) VALUES('bob','2b58af6dddbd072ed27ffc86725d7d3a',1)");
        template.execute("INSERT INTO USERS  (USERNAME, PASSWORD, ENABLED) VALUES('jane','2b58af6dddbd072ed27ffc86725d7d3a',1)");
 ...
 /*
        for (int i = 10; i < createEntities; i++) {
            ...
            template.execute("INSERT INTO contacts (ID, CONTACT_NAME, EMAIL) VALUES (" + i + ", '" + person[2] + "', '" + person[0].toLowerCase()
...
*/
        ...
        for (int i = 1; i < createEntities; i++) {
            final ObjectIdentity objectIdentity = new ObjectIdentityImpl(BankingTx.class, new Long(i));
    ...
    private void changeOwner(int contactNumber, String newOwnerUsername) {
        AclImpl acl = (AclImpl) mutableAclService.readAclById(new ObjectIdentityImpl(BankingTx.class,
